package com.nttdata.customer.service.customerservice.configuration.mongodb;
...
@Configuration
@EnableReactiveMongoRepositories(basePackages = "com.nttdata.customer.service.customerservice.repository")
public class MongoConnection extends AbstractReactiveMongoConfiguration{
    ...
    public Collection<String> getMappingBasePackages() {
       return Collections.singleton("com.nttdata.customer.service.customerservice");
    }
